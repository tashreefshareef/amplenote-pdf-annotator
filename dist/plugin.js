...
var __pluginModule=(()=>{var xe=Object.defineProperty;var Ft=Object.getOwnPropertyDescriptor;var Ot=Object.getOwnPropertyNames;var $t=Object.prototype.hasOwnProperty;var _t=(t,s)=>{for(var a in s)xe(t,a,{get:s[a],enumerable:!0})},jt=(t,s,a,l)=>{if(s&&typeof s=="object"||typeof s=="function")for(let i of Ot(s))!$t.call(t,i)&&i!==a&&xe(t,i,{get:()=>s[i],enumerable:!(l=Ft(s,i))||l.enumerable});return t};var Bt=t=>jt(xe({},"__esModule",{value:!0}),t);var on={};_t(on,{default:()=>nn});var ae=[{id:"coral",label:"Coral",hex:"#F3998C",cycleIndex:12,rgb:[.953,.6,.549]},{id:"yellow",label:"Yellow",hex:"#F4DE6C",cycleIndex:14,rgb:[.957,.871,.424]},{id:"green",label:"Green",hex:"#BBE077",cycleIndex:15,rgb:[.733,.878,.467]},{id:"blue",label:"Blue",hex:"#84B6D9",cycleIndex:18,rgb:[.518,.714,.851]}],re="yellow",J="PDF Annotator data",_e="attachment://",je=1.2,Be=16,ee={pdfJs:"https://cdnjs.cloudflare.com/ajax/libs/pdf.js/3.11.174/pdf.min.js",pdfJsWorker:"https://cdnjs.cloudflare.com/ajax/libs/pdf.js/3.11.174/pdf.worker.min.js",pdfViewerCss:"https://cdnjs.cloudflare.com/ajax/libs/pdf.js/3.11.174/pdf_viewer.min.css",pdfLib:"https://cdnjs.cloudflare.com/ajax/libs/pdf-lib/1.17.1/pdf-lib.min.js"},zt="https://plugins.amplenote.com/cors-proxy";function ze(t){let s=new URL(zt);return s.searchParams.set("apiurl",t),s.toString()}var qt="application/pdf";function Gt(t){return Array.isArray(t)?t.filter(s=>s&&s.type===qt&&s.uuid):[]}async function ie(t,s){let a=await t.getNoteAttachments({uuid:s}),l=Gt(a);if(l.length===0)return null;if(l.length===1)return l[0];let i=await t.prompt("Which PDF do you want to annotate?",{inputs:[{label:"PDF",type:"radio",options:l.map(n=>({label:n.name,value:n.uuid})),value:l[0].uuid}]});if(i==null)return null;let c=Array.isArray(i)?i[0]:i;return l.find(n=>n.uuid===c)||null}async function qe(t,s){if(!s)throw new Error("fetchableAttachmentURL: attachmentUUID required");let a=await t.getAttachmentURL(s);if(!a)throw new Error(`No URL returned for attachment ${s}`);return ze(a)}function Ge(t){return t?Be:je}function te(t){let s={attachmentUUID:null,page:null,x:null,y:null,highlightId:null,noteUUID:null,collapsed:!1,attachmentName:""};if(!t||typeof t!="string")return s;let a;try{a=new URLSearchParams(t.replace(/^\?/,""))}catch{return s}let l=c=>{let n=a.get(c);if(n===null||n.trim()==="")return null;let h=Number(n);return Number.isFinite(h)?h:null},i=l("page");return{attachmentUUID:a.get("att")||null,page:i!==null&&i>=1?Math.floor(i):null,x:l("x"),y:l("y"),highlightId:a.get("hl")||null,noteUUID:a.get("note")||null,collapsed:a.get("c")==="1",attachmentName:a.get("n")||""}}function Ve({attachmentUUID:t,page:s,x:a,y:l,highlightId:i,collapsed:c,attachmentName:n}={}){let h=new URLSearchParams;return t&&h.set("att",t),c&&h.set("c","1"),n&&h.set("n",n),Number.isFinite(s)&&s>=1&&h.set("page",String(Math.floor(s))),Number.isFinite(a)&&h.set("x",String(a)),Number.isFinite(l)&&h.set("y",String(l)),i&&h.set("hl",i),h.toString()}function se(t,s={},a=null){if(!t)throw new Error("buildEmbedMarkup: pluginUUID required");a===null&&(a=Ge(s.collapsed));let l=Ve(s);return`<object data="${l?`plugin://${t}?${l}`:`plugin://${t}`}" data-aspect-ratio="${a}" />`}function We(t,s,a){if(!t||!s||!a)return null;let l=t.split(`
`),i=l.findIndex(n=>n.includes(`${_e}${s}`));if(i===-1)return null;let c=l.slice();return l[i+1]===""?c.splice(i+2,0,a.trim(),""):c.splice(i+1,0,"",a.trim(),""),c.join(`
`)}function le(t,s,a=null){return!t||!s||!t.includes(`plugin://${s}`)?!1:a?t.includes(`att=${a}`):!0}function Je(t,s,a){if(!t||!s||!a)return null;let l=t.split(`
...
`)}function be(t,s,a,l={}){if(!t||!s||!a)return null;let i=t.split(`
`),c=`plugin://${s}`,n=i.findIndex(S=>S.includes(c)&&S.includes(`att=${a}`));if(n===-1)return null;let h=i[n],w=h.match(/data="(plugin:\/\/[^"]*)"/);if(!w)return null;let g=w[1],I=g.indexOf("?"),T=I===-1?"":g.slice(I+1),C={...te(T),attachmentUUID:a,...l},p=Ve(C),f=p?`plugin://${s}?${p}`:`plugin://${s}`,v=i.slice(),m=h.replace(w[0],`data="${f}"`),y=Ge(C.collapsed),N=m.match(/data-aspect-ratio="[^"]*"/);return m=N?m.replace(N[0],`data-aspect-ratio="${y}"`):m.replace(/\s*\/>\s*$/,` data-aspect-ratio="${y}" />`),v[n]=m,v.join(`
`)}function Xe(t,s,a,l){return be(t,s,a,{collapsed:!!l})}async function Ye(t,s,a){let l=await ie(t,s);if(!l){let h=await t.getNoteAttachments({uuid:s});return(!(Array.isArray(h)&&h.length>0)||!h.some(g=>g&&g.type==="application/pdf"))&&await t.alert(`No PDF attachments on this note.

Attach a PDF with the paperclip button in the note toolbar, then run this again.`),null}let i=await t.getNoteContent({uuid:s});if(le(i,a,l.uuid))return await t.alert(`"${l.name}" is already open in this note - scroll to the viewer.`),l.uuid;let c=se(a,{attachmentUUID:l.uuid,attachmentName:l.name}),n=We(i,l.uuid,c);return n!==null?(await t.replaceNoteContent({uuid:s},n),l.uuid):(await t.insertNoteContent({uuid:s},`
${c}
`,{atEnd:!0}),l.uuid)}var Vt="Raw markdown";function Wt(t){let s=(String(t||"").match(/`+/g)||[]).reduce((a,l)=>Math.max(a,l.length),0);return"`".repeat(Math.max(3,s+1))}async function Qe(t,s){let a=await t.getNoteContent({uuid:s});if(typeof a!="string"||a==="")return await t.alert("That note came back empty - nothing to dump."),null;let l=await t.getNoteAttachments({uuid:s}),i=(Array.isArray(l)?l:[]).map(h=>`- ${h&&h.name} | ${h&&h.type} | ${h&&h.uuid}`).join(`
`),c=Wt(a),n=await t.createNote("PDF Annotator debug - note markdown");return await t.insertNoteContent({uuid:n},`# Attachments
...
Open it and look for how the PDF attachment is referenced.`),n}async function Ze(t,s,a){if(!s)return"";let l=await ie(t,s);if(!l){let c=await t.getNoteAttachments({uuid:s});return(!(Array.isArray(c)&&c.length>0)||!c.some(h=>h&&h.type==="application/pdf"))&&await t.alert(`No PDF attachments on this note.

Attach a PDF with the paperclip button in the note toolbar, then type {PDF Annotator} again where you want the viewer.`),""}let i=await t.getNoteContent({uuid:s});return le(i,a,l.uuid)?(await t.alert(`"${l.name}" already has a viewer in this note.

Detach that one first if you want to move it here.`),""):`
${se(a,{attachmentUUID:l.uuid,attachmentName:l.name})}
`}async function Ke(t,s){let{noteUUID:a,attachmentUUID:l,page:i,highlightId:c}=te(s);if(!a){await t.alert("This link doesn't say which note the PDF lives on - it was likely exported by an older version of this plugin. Re-export the highlight to get a working link.");return}try{let n=await t.getNoteContent({uuid:a}),h=be(n,t.context.pluginUUID,l,{page:i,highlightId:c,collapsed:!1});h!==null&&await t.replaceNoteContent({uuid:a},h)}catch{}await t.navigate(`https://www.amplenote.com/notes/${a}`)}function de(t){if(!t)return null;let s=String(t).trim().toLowerCase();return ae.find(a=>a.id===s||a.hex.toLowerCase()===s)||null}function et(){return de(re)}function Jt(){return"hl-"+Date.now().toString(36)+"-"+Math.random().toString(36).slice(2,8)}function ce({page:t,color:s,rects:a,quoteText:l,note:i=null,id:c=null}){if(!Number.isInteger(t)||t<1)throw new Error(`createHighlight: page must be a positive integer, got ${t}`);if(!Array.isArray(a)||a.length===0)throw new Error("createHighlight: rects must be a non-empty array");for(let h of a)if(![h.x,h.y,h.width,h.height].every(Number.isFinite))throw new Error(`createHighlight: malformed rect ${JSON.stringify(h)}`);let n=de(s)||et();return{id:c||Jt(),page:t,color:n.id,rects:a.map(h=>({x:h.x,y:h.y,width:h.width,height:h.height})),quoteText:String(l||""),note:i?String(i):null}}function tt(t,s){let a=s==null?null:String(s).trim();return{...t,note:a||null}}function nt(t,s){let a=de(s);if(!a)throw new Error(`withColor: unknown color "${s}"`);return{...t,color:a.id}}function ot(t,s){return(t||[]).filter(a=>a.id!==s)}function ye(t,s,a){let l=!1,i=(t||[]).map(c=>c.id!==s?c:(l=!0,a(c)));return l?i:t}var Xt="json",Yt="*Managed automatically by the PDF Annotator plugin - safe to ignore, don't edit.*";function at(t){let s=JSON.stringify(t,null,0).replace(/`/g,"\\u0060");return`${Yt}
\`\`\`${Xt}
${s}
\`\`\``}function Ce(t){if(!t)return null;let s=t.match(/```(?:json)?\s*\n?([\s\S]*?)\n?```/),a=!s&&t.match(/<!--\s*PDFA-DATA\s*\n?([\s\S]*?)-->/),l=(s?s[1]:a?a[1]:t).trim();if(!l)return null;try{return JSON.parse(l)}catch{return null}}function Qt(t){if(!Array.isArray(t))return[];let s=[];for(let a of t)try{s.push(ce(a))}catch{}return s}async function he(t,s,a){let l=await t.getNoteContent({uuid:s}),i=Ee(l,J),c=Ce(i);return!c||typeof c!="object"?[]:Qt(c[a])}async function rt(t,s,a,l){let i={uuid:s},c=await t.getNoteContent(i),n=Ee(c,J),w={...Ce(n)||{},[a]:l},g=at(w);n===null&&await t.insertNoteContent(i,`

# ${J}

`,{atEnd:!0}),await t.replaceNoteContent(i,g,{section:{heading:{text:J,level:1}}})}async function it(t,s,a){let l={uuid:s},i=await t.getNoteContent(l),c=Ee(i,J);if(c===null)return;let n=Ce(c)||{};if(!(a in n))return;let h={...n};delete h[a],await t.replaceNoteContent(l,at(h),{section:{heading:{text:J,level:1}}})}function Ee(t,s){if(!t)return null;let a=t.split(`
...
`).trim()}function B(t,s){return s.noteUUID||t.context.noteUUID}async function st(t,s,a){try{let l=await t.getNoteAttachments({uuid:s}),i=Array.isArray(l)&&l.find(c=>c&&c.uuid===a);return i?i.name:""}catch{return""}}async function pe(t,s,a,l){let i=await he(t,s,a),c=l(i);return c!==i&&await rt(t,s,a,c),{highlights:c}}function lt(t){if(t&&typeof t=="object")return t;if(typeof t!="string")return{};let s=t.trim();if(!s.startsWith("{"))return{action:s};try{return JSON.parse(s)}catch{return{action:s}}}async function dt(t,s){return JSON.stringify(await Zt(t,lt(s)))}async function Zt(t,s){let a=lt(s);switch(a.action){case"getPdfUrl":{let l=a.attachmentUUID;if(!l)return{error:"No attachment specified for this viewer."};try{return{url:await qe(t,l),name:await st(t,B(t,a),l)}}catch(i){return{error:`Could not load the PDF: ${i.message}`}}}case"loadHighlights":{if(!a.attachmentUUID)return{error:"No attachment specified for this viewer."};try{return{highlights:await he(t,B(t,a),a.attachmentUUID)}}catch(l){return{error:`Could not load highlights: ${l.message}`}}}case"addHighlight":{if(!a.attachmentUUID)return{error:"No attachment specified for this viewer."};try{let l=ce(a.highlight||{});return await pe(t,B(t,a),a.attachmentUUID,i=>i.concat([l]))}catch(l){return{error:`Could not save the highlight: ${l.message}`}}}case"recolorHighlight":{if(!a.attachmentUUID)return{error:"No attachment specified for this viewer."};try{return await pe(t,B(t,a),a.attachmentUUID,l=>ye(l,a.id,i=>nt(i,a.color)))}catch(l){return{error:`Could not change the highlight color: ${l.message}`}}}case"setHighlightNote":{if(!a.attachmentUUID)return{error:"No attachment specified for this viewer."};try{return await pe(t,B(t,a),a.attachmentUUID,l=>ye(l,a.id,i=>tt(i,a.note)))}catch(l){return{error:`Could not save the note: ${l.message}`}}}case"removeHighlight":{if(!a.attachmentUUID)return{error:"No attachment specified for this viewer."};try{return await pe(t,B(t,a),a.attachmentUUID,l=>ot(l,a.id))}catch(l){return{error:`Could not remove the highlight: ${l.message}`}}}case"sendToNote":{if(!a.content)return{error:"Nothing to send."};try{return await t.insertNoteContent({uuid:B(t,a)},`
`+a.content+`
`,{atEnd:!0}),{ok:!0}}catch(l){return{error:`Could not add this to the note: ${l.message}`}}}case"removeViewer":{if(!a.attachmentUUID)return{error:"No attachment specified for this viewer."};if(!a.pluginUUID)return{error:"Missing plugin id - cannot locate this viewer."};try{let l=B(t,a),i=await t.getNoteContent({uuid:l}),c=Je(i,a.pluginUUID,a.attachmentUUID);return c===null?{error:"Could not find this viewer's block in the note - it may already be removed."}:(await t.replaceNoteContent({uuid:l},c),await it(t,l,a.attachmentUUID),{ok:!0})}catch(l){return{error:`Could not remove this viewer: ${l.message}`}}}case"getViewerSummary":{if(!a.attachmentUUID)return{error:"No attachment specified for this viewer."};let l=B(t,a),i=await st(t,l,a.attachmentUUID);try{let c=await he(t,l,a.attachmentUUID);return{name:i,count:c.length}}catch{return{name:i,count:0}}}case"setCollapsed":{if(!a.attachmentUUID)return{error:"No attachment specified for this viewer."};if(!a.pluginUUID)return{error:"Missing plugin id - cannot locate this viewer."};try{let l=B(t,a),i=await t.getNoteContent({uuid:l}),c=Xe(i,a.pluginUUID,a.attachmentUUID,a.collapsed);return c===null?{ok:!1}:(await t.replaceNoteContent({uuid:l},c),{ok:!0})}catch(l){return{error:`Could not resize this viewer: ${l.message}`}}}case"exportAll":{if(!a.noteName)return{error:"Missing destination note name."};try{let l=await t.findNote({name:a.noteName}),i=l?l.uuid:await t.createNote(a.noteName);return await t.replaceNoteContent({uuid:i},a.content||""),{ok:!0,noteUUID:i}}catch(l){return{error:`Could not export highlights: ${l.message}`}}}case"ping":return{ok:!0};default:return{error:`Unknown embed action: ${String(a.action)}`}}}function Ne(){function t(p,f){return{x:p.left-f.left,y:p.top-f.top,width:p.width,height:p.height}}function s(p,f){return{x:Math.min(p[0],f[0]),y:Math.min(p[1],f[1]),width:Math.abs(f[0]-p[0]),height:Math.abs(f[1]-p[1])}}function a(p,f){var v=Math.pow(10,f===void 0?2:f),m=function(y){return Math.round(y*v)/v};return{x:m(p.x),y:m(p.y),width:m(p.width),height:m(p.height)}}function l(p){return p.width>.01&&p.height>.01}function i(p,f,v){for(var m=String(p??""),y=Math.max(0,f===void 0?0:f),N=Math.min(m.length,v===void 0?m.length:v),S=function($){return $===""||/\s/.test($)},U=[],k=y;k<N;){for(;k<N&&S(m.charAt(k));)k++;if(k>=N)break;for(var O=k;k<N&&!S(m.charAt(k));)k++;U.push({start:O,end:k})}return U}function c(p){for(var f=1/0,v=1/0,m=-1/0,y=-1/0,N=0;N<(p?p.length:0);N++){var S=p[N];l(S)&&(f=Math.min(f,S.left),v=Math.min(v,S.top),m=Math.max(m,S.left+S.width),y=Math.max(y,S.top+S.height))}return isFinite(f)?{left:f,top:v,width:m-f,height:y-v}:null}function n(p,f,v){for(var m=[],y=0;y<p.length;y++){var N=t(p[y],f);if(l(N)){var S=v(N.x,N.y),U=v(N.x+N.width,N.y+N.height),k=a(s(S,U));l(k)&&m.push(k)}}return m}function h(p,f){var v=f(p.x,p.y),m=f(p.x+p.width,p.y+p.height);return s(v,m)}function w(p,f,v){var m=f.right-f.left,y=f.bottom-f.top;if(m<=0||y<=0)return null;var N=p.x2-p.x1,S=p.y2-p.y1,U=p.x1+(v.left-f.left)/m*N,k=p.x2-(f.right-v.right)/m*N,O=p.y1+(v.bottom-f.bottom)/y*S,$=p.y2-(f.top-v.top)/y*S;return{x:U,y:O,width:k-U,height:$-O}}function g(p,f){var v=Math.min(p.y+p.height,f.y+f.height)-Math.max(p.y,f.y);return v>.5*Math.min(p.height,f.height)}function I(p,f){var v=f===void 0?.6:f;if(!p||p.length<2)return(p||[]).slice();for(var m=p.slice().sort(function(G,W){return W.y-G.y||G.x-W.x}),y=[],N=0;N<m.length;N++){for(var S=!1,U=0;U<y.length;U++)if(g(y[U][0],m[N])){y[U].push(m[N]),S=!0;break}S||y.push([m[N]])}for(var k=[],O=0;O<y.length;O++){for(var $=y[O].slice().sort(function(G,W){return G.x-W.x}),D=null,Z=0;Z<$.length;Z++){var H=$[Z];if(D===null){D={x:H.x,y:H.y,width:H.width,height:H.height};continue}var ne=H.x-(D.x+D.width);if(ne<=v*Math.max(D.height,H.height)){var ue=Math.max(D.x+D.width,H.x+H.width),z=Math.max(D.y+D.height,H.y+H.height);D.x=Math.min(D.x,H.x),D.y=Math.min(D.y,H.y),D.width=ue-D.x,D.height=z-D.y}else k.push(D),D={x:H.x,y:H.y,width:H.width,height:H.height}}D!==null&&k.push(D)}return k.map(function(G){return a(G)})}function T(p,f,v,m){var y=m===void 0?0:m;return f>=p.x-y&&f<=p.x+p.width+y&&v>=p.y-y&&v<=p.y+p.height+y}function E(p,f,v,m,y){for(var N=p||[],S=N.length-1;S>=0;S--){var U=N[S];if(!(!U||U.page!==f||!U.rects)){for(var k=0;k<U.rects.length;k++)if(T(U.rects[k],v,m,y===void 0?1:y))return U}}return null}function C(p){return String(p??"").replace(/\s+/g," ").trim()}return{clientRectToLocal:t,rectFromCorners:s,roundRect:a,isVisibleRect:l,textTokenRanges:i,unionClientRects:c,clientRectsToPdfRects:n,pdfRectToViewportRect:h,itemRelativeRect:w,mergeLineRects:I,rectContainsPoint:T,hitTestHighlights:E,normalizeQuoteText:C}}var j=Ne(),Un=j.clientRectToLocal,Hn=j.rectFromCorners,Rn=j.roundRect,Ln=j.isVisibleRect,Mn=j.textTokenRanges,Fn=j.unionClientRects,On=j.clientRectsToPdfRects,$n=j.pdfRectToViewportRect,_n=j.itemRelativeRect,jn=j.mergeLineRects,Bn=j.rectContainsPoint,zn=j.hitTestHighlights,qn=j.normalizeQuoteText;function Te(){var t=[.957,.871,.424];function s(c,n,h,w,g){var I=n.context.register(n.context.obj({Type:c.PDFName.of("ExtGState"),BM:c.PDFName.of("Multiply"),ca:c.PDFNumber.of(.4)})),T=[c.pushGraphicsState(),c.setGraphicsState("GS0")];T.push(c.setFillingColor(c.rgb(w[0],w[1],w[2])));for(var E=0;E<h.length;E++){var C=h[E];T.push(c.moveTo(C.x,C.y)),T.push(c.lineTo(C.x,C.y+C.height)),T.push(c.lineTo(C.x+C.width,C.y+C.height)),T.push(c.lineTo(C.x+C.width,C.y)),T.push(c.closePath())}T.push(c.fill()),T.push(c.popGraphicsState());var p=n.context.formXObject(T,{BBox:g,Resources:{ExtGState:{GS0:I}}});return n.context.register(p)}function a(c,n,h,w){for(var g=h.rects,I=[],T=g[0].x,E=g[0].y,C=g[0].x+g[0].width,p=g[0].y+g[0].height,f=0;f<g.length;f++){var v=g[f],m=v.x,y=v.x+v.width,N=v.y,S=v.y+v.height;I.push(m,S,y,S,m,N,y,N),T=Math.min(T,m),E=Math.min(E,N),C=Math.max(C,y),p=Math.max(p,S)}var U=n.context.obj({Type:c.PDFName.of("Annot"),Subtype:c.PDFName.of("Highlight"),Rect:n.context.obj([T,E,C,p]),QuadPoints:n.context.obj(I),C:n.context.obj(w),F:c.PDFNumber.of(4),T:c.PDFString.of("PDF Annotator"),M:c.PDFString.of(new Date().toISOString()),CA:c.PDFNumber.of(.4)});h.note&&U.set(c.PDFName.of("Contents"),c.PDFString.of(h.note));var k=s(c,n,g,w,[T,E,C,p]);U.set(c.PDFName.of("AP"),n.context.obj({N:k}));var O=n.context.register(U),$=[O];if(h.note){var D=n.context.register(n.context.obj({Type:c.PDFName.of("Annot"),Subtype:c.PDFName.of("Popup"),Rect:n.context.obj([C+8,E-60,C+208,E+12]),Parent:O,Open:!1}));U.set(c.PDFName.of("Popup"),D),$.push(D)}return $}function l(c,n,h){var w=n.node.get(c.PDFName.of("Annots"));if(w instanceof c.PDFArray)for(var g=0;g<h.length;g++)w.push(h[g]);else n.node.set(c.PDFName.of("Annots"),n.doc.context.obj(h))}async function i(c,n,h,w){for(var g=await c.PDFDocument.load(n),I=g.getPages(),T=h||[],E=0;E<T.length;E++){var C=T[E];if(!(!C||!C.rects||!C.rects.length)){var p=I[C.page-1];if(p){var f=w&&w[C.color]||t,v=a(c,g,C,f);l(c,p,v)}}}return g.save()}return{writeHighlightsIntoPdf:i,buildHighlightAnnotation:a,appendAnnotationRefs:l}}var Se=Te(),Vn=Se.writeHighlightsIntoPdf,Wn=Se.buildHighlightAnnotation,Jn=Se.appendAnnotationRefs;function Ae(){function t(n){return String(n??"").replace(/\]/g,"\\]")}function s(n,h,w,g,I){var T=new URLSearchParams;h&&T.set("att",h),Number.isFinite(w)&&w>=1&&T.set("page",String(Math.floor(w))),g&&T.set("hl",g),I&&T.set("note",I);var E=T.toString();return"plugin://"+n+(E?"?"+E:"")}function a(n,h){return String(n??"").split(/\r?\n/).map(function(w){return(h+" "+w).replace(/[ \t]+$/,"")})}function l(n,h,w,g,I,T){var E=s(h,w,g.page,g.id,T),C=t(n||"PDF"),p='==\u25CF<!-- {"cycleColor":"'+I+'"} -->==',f=p+" ["+C+"]("+E+")",v=[f].concat(a(g.quoteText,"> >"));return g.note&&(v.push(">"),v=v.concat(a(g.note,">"))),v.join(`
...
`)}return{buildDeepLink:s,buildHighlightBlock:l,buildExportAllContent:c}}var Ie=Ae(),Yn=Ie.buildDeepLink,Qn=Ie.buildHighlightBlock,Zn=Ie.buildExportAllContent;function ct(){var t=window.__PDFA_CONFIG||{},s=window.__PDFA_GEOM||{},a=window.__PDFA_ANNOTATIONS||{},l=window.__PDFA_EXPORT||{},i={root:document.getElementById("pdfa-root"),pages:document.getElementById("pdfa-pages"),status:document.getElementById("pdfa-status"),pageLabel:document.getElementById("pdfa-page-label"),zoomLabel:document.getElementById("pdfa-zoom-label"),colors:document.getElementById("pdfa-colors"),hint:document.getElementById("pdfa-hint"),popover:document.getElementById("pdfa-popover"),panel:document.getElementById("pdfa-panel"),listToggle:document.getElementById("pdfa-list-toggle"),count:document.getElementById("pdfa-count"),more:document.getElementById("pdfa-more"),open:document.getElementById("pdfa-open"),collapsedCount:document.getElementById("pdfa-collapsed-count"),collapsedName:document.querySelector(".pdfa-collapsed-name"),name:document.querySelector(".pdfa-name")};function c(e){e&&(n.attachmentName=e,i.name&&(i.name.textContent=e),i.collapsedName&&(i.collapsedName.textContent=e))}var n={doc:null,scale:1.25,pageCount:0,current:1,rendering:!1,textSpans:0,viewports:{},highlights:[],pdfBytes:null,attachmentName:t.attachmentName||"",activeColorId:t.defaultColorId||((t.colors||[{}])[0]||{}).id,pendingSelection:null,lastCapturedText:"",noteEditing:null};function h(e,o){i.status.textContent=e||"",i.status.style.display=e?"block":"none",i.status.className=o?"pdfa-status pdfa-error":"pdfa-status"}function w(e){var o=Object.assign({noteUUID:t.noteUUID},e);return new Promise(function(r,d){try{if(typeof window.callAmplenotePlugin!="function")throw new Error("Plugin bridge unavailable (callAmplenotePlugin missing)");r(window.callAmplenotePlugin(JSON.stringify(o)))}catch(u){d(u)}}).then(function(r){if(r&&typeof r=="object")return r;if(typeof r!="string")throw new Error("Empty reply from the plugin");try{return JSON.parse(r)}catch{throw new Error("Unreadable reply from the plugin: "+String(r).slice(0,120))}})}function g(){return t.colors||[]}function I(e){for(var o=g(),r=0;r<o.length;r++)if(o[r].id===e)return o[r].hex;return o.length?o[0].hex:"#F4DE6C"}function T(e){for(var o=0;o<n.highlights.length;o++)if(n.highlights[o].id===e)return n.highlights[o];return null}function E(e,o,r){var d=document.createElement("button");return d.className="pdfa-btn"+(o?" "+o:""),d.textContent=e,d.onclick=function(u){u.stopPropagation(),r()},d}function C(e,o,r,d){var u=document.createElement("button");return u.className="pdfa-color",u.dataset.color=e.id,u.style.background=e.hex,u.title=d+" "+e.label,u.setAttribute("aria-label",d+" "+e.label),u.setAttribute("aria-pressed",String(!!o)),u.onclick=function(x){x.stopPropagation(),r(e.id)},u}function p(){for(var e=g(),o=0;o<e.length;o++)i.colors.appendChild(C(e[o],e[o].id===n.activeColorId,function(r){n.activeColorId=r,f(),n.pendingSelection&&ke(n.pendingSelection,r)},"Highlight"))}function f(){for(var e=i.colors.querySelectorAll(".pdfa-color"),o=0;o<e.length;o++)e[o].setAttribute("aria-pressed",String(e[o].dataset.color===n.activeColorId))}function v(e,o){var r=e.getViewport({scale:n.scale});n.viewports[o]=r;var d=document.createElement("div");d.className="pdfa-page",d.dataset.page=String(o),d.style.width=r.width+"px",d.style.height=r.height+"px";var u=document.createElement("canvas"),x=window.devicePixelRatio||1;u.width=Math.floor(r.width*x),u.height=Math.floor(r.height*x),u.style.width=r.width+"px",u.style.height=r.height+"px",d.appendChild(u);var b=document.createElement("div");b.className="pdfa-highlights",d.appendChild(b);var A=document.createElement("div");A.className="textLayer",A.style.width=r.width+"px",A.style.height=r.height+"px",A.style.setProperty("--scale-factor",String(n.scale)),d.appendChild(A),i.pages.appendChild(d);var R=u.getContext("2d");return R.scale(x,x),e.render({canvasContext:R,viewport:r}).promise.then(function(){return e.getTextContent()}).then(function(F){var P=[];return window.pdfjsLib.renderTextLayer({textContent:F,container:A,viewport:r,textDivs:P}).promise.then(function(){n.textSpans+=P.length;for(var L=0;L<P.length;L++)P[L].__pdfaItem=F.items[L];N(o)})})}function m(){if(n.rendering)return Promise.resolve();n.rendering=!0,M(!0),i.pages.innerHTML="",n.viewports={},n.textSpans=0,h("Rendering...");for(var e=Promise.resolve(),o=1;o<=n.pageCount;o++)(function(r){e=e.then(function(){return n.doc.getPage(r).then(function(d){return v(d,r)})})})(o);return e.then(function(){n.textSpans===0?h("No selectable text found - this PDF may be a scan.",!0):h(""),n.rendering=!1,K()}).catch(function(r){n.rendering=!1,h("Failed to render: "+r.message,!0)})}function y(e){return function(o,r){return e.convertToViewportPoint(o,r)}}function N(e){for(var o=e?'.pdfa-page[data-page="'+e+'"]':".pdfa-page",r=i.pages.querySelectorAll(o),d=0;d<r.length;d++){var u=r[d],x=Number(u.dataset.page),b=u.querySelector(".pdfa-highlights"),A=n.viewports[x];if(!(!b||!A)){b.innerHTML="";for(var R=y(A),F=0;F<n.highlights.length;F++){var P=n.highlights[F];if(!(!P||P.page!==x||!P.rects||!P.rects.length)){var L=document.createElement("div");L.className="pdfa-hl-group",L.dataset.id=P.id||"";for(var V=0;V<P.rects.length;V++){var Y=s.pdfRectToViewportRect(P.rects[V],R),_=document.createElement("div");_.className="pdfa-hl",_.style.left=Y.x+"px",_.style.top=Y.y+"px",_.style.width=Y.width+"px",_.style.height=Y.height+"px",_.style.background=I(P.color),L.appendChild(_)}b.appendChild(L)}}}}}function S(){N(),k(),i.count.textContent=String(n.highlights.length)}function U(){return n.highlights.slice().sort(function(e,o){return e.page!==o.page?e.page-o.page:(o.rects[0]?o.rects[0].y:0)-(e.rects[0]?e.rects[0].y:0)})}function k(){i.panel.innerHTML="";var e=document.createElement("div");e.className="pdfa-panel-title";var o=document.createElement("span");o.textContent="Highlights",e.appendChild(o),e.appendChild(E("Close","",function(){$(!1)})),i.panel.appendChild(e);var r=U();if(!r.length){var d=document.createElement("div");d.className="pdfa-panel-empty",d.textContent="No highlights yet. Select some text in the PDF and pick a color.",i.panel.appendChild(d);return}for(var u=0;u<r.length;u++)i.panel.appendChild(O(r[u]))}function O(e){var o=document.createElement("div");o.className="pdfa-hl-row",o.dataset.id=e.id||"",o.title="Jump to this highlight";var r=document.createElement("span");r.className="pdfa-chip",r.style.background=I(e.color),o.appendChild(r);var d=document.createElement("div"),u=document.createElement("div");u.className="pdfa-hl-page",u.textContent="Page "+e.page,d.appendChild(u);var x=document.createElement("div");if(x.className="pdfa-hl-quote",x.textContent=e.quoteText.length>160?e.quoteText.slice(0,160)+"...":e.quoteText,d.appendChild(x),e.note){var b=document.createElement("div");b.className="pdfa-hl-note",b.textContent=e.note,d.appendChild(b)}return o.appendChild(d),o.onclick=function(){Pe(e)},o}function $(e){var o=e===void 0?!i.panel.classList.contains("pdfa-open"):e;i.panel.classList.toggle("pdfa-open",o),i.listToggle.setAttribute("aria-pressed",String(o)),o&&k()}function D(e){for(var o=e&&e.nodeType===1?e:e&&e.parentElement;o;){if(o.classList&&o.classList.contains("textLayer"))return o;o=o.parentElement}return null}function Z(e,o){for(var r=[],d=[],u=null,x=document.createTreeWalker(o,NodeFilter.SHOW_TEXT,null),b;b=x.nextNode();)if(e.intersectsNode(b)){var A=b.nodeValue||"",R=b===e.startContainer?e.startOffset:0,F=b===e.endContainer?e.endOffset:A.length,P=b.parentElement,L=P&&P.__pdfaItem;if(L)for(var V={x1:L.transform[4],y1:L.transform[5],x2:L.transform[4]+L.width,y2:L.transform[5]+L.height},Y=P.getBoundingClientRect(),_=s.textTokenRanges(A,R,F),Q=0;Q<_.length;Q++){var we=document.createRange();we.setStart(b,_[Q].start),we.setEnd(b,_[Q].end);var q=s.unionClientRects(we.getClientRects());if(q){var Oe={left:q.left,top:q.top,width:q.width,height:q.height,right:q.left+q.width,bottom:q.top+q.height},$e=s.itemRelativeRect(V,Y,Oe);$e&&(r.push($e),d.push(A.slice(_[Q].start,_[Q].end)),u=Oe)}}}return{rects:r,text:d.join(" "),lastCssRect:u}}function H(e){if(n.pendingSelection=e,n.lastCapturedText=e&&e.rawText||"",!e){i.hint.textContent="",i.hint.style.display="none";return}i.hint.textContent=e.spilled?"Pick a color (page "+e.page+" only)":"Pick a color",i.hint.style.display="inline"}function ne(e){if(!n.noteEditing){var o=window.getSelection();if(!o||o.isCollapsed||o.rangeCount===0){H(null),M();return}var r=o.getRangeAt(0),d=D(r.startContainer);if(!d)return H(null);var u=d.parentElement;if(!u||!u.dataset||!u.dataset.page)return H(null);var x=Number(u.dataset.page);if(!n.viewports[x])return H(null);var b=D(r.endContainer)!==d,A=Z(r,d),R=s.mergeLineRects(A.rects);if(!R.length)return H(null);var F=A.lastCssRect||u.getBoundingClientRect(),P=e&&e.clientX?e.clientX:F.left+F.width/2,L=e&&e.clientY?e.clientY:F.top+F.height,V={page:x,rects:R,quoteText:s.normalizeQuoteText(A.text),spilled:b,anchorX:P,anchorY:L,rawText:String(o)};H(V),mt(V)}}var ue=300,z=null;function G(){n.noteEditing||(z&&clearTimeout(z),z=setTimeout(W,ue))}function W(){if(z=null,!n.noteEditing){var e=window.getSelection();!e||e.isCollapsed||e.rangeCount===0||D(e.getRangeAt(0).startContainer)&&String(e)!==n.lastCapturedText&&ne(null)}}function oe(e,o){var r=n.highlights;return n.highlights=e,S(),w(o).then(function(d){if(!d||d.error)throw new Error(d&&d.error||"The plugin did not confirm the change.");return n.highlights=d.highlights||e,S(),h(""),!0}).catch(function(d){return n.highlights=r,S(),h(d.message||String(d),!0),!1})}function ke(e,o){var r={id:null,page:e.page,color:o,rects:e.rects,quoteText:e.quoteText,note:null},d=e.anchorX,u=e.anchorY;H(null),M(!0);var x=window.getSelection();x&&x.removeAllRanges&&x.removeAllRanges(),oe(n.highlights.concat([r]),{action:"addHighlight",attachmentUUID:t.attachmentUUID,highlight:r}).then(function(b){if(b){var A=n.highlights[n.highlights.length-1];A&&A.id&&ge(A,d,u,!0)}})}function ft(e,o){M(!0),oe(n.highlights.map(function(r){return r.id===e?Object.assign({},r,{color:o}):r}),{action:"recolorHighlight",attachmentUUID:t.attachmentUUID,id:e,color:o})}function gt(e){M(!0),oe(n.highlights.filter(function(o){return o.id!==e}),{action:"removeHighlight",attachmentUUID:t.attachmentUUID,id:e})}function fe(e,o){var r=String(o??"").trim();n.noteEditing=null,M(!0),oe(n.highlights.map(function(d){return d.id===e?Object.assign({},d,{note:r||null}):d}),{action:"setHighlightNote",attachmentUUID:t.attachmentUUID,id:e,note:r})}function X(e,o,r,d){i.popover.innerHTML="",i.popover.classList.toggle("pdfa-editing",d==="editing"),i.popover.classList.toggle("pdfa-exporting",d==="exporting"),i.popover.classList.toggle("pdfa-menu",d==="menu");for(var u=0;u<e.length;u++)i.popover.appendChild(e[u]);i.popover.classList.add("pdfa-open");var x=i.popover.offsetWidth,b=i.popover.offsetHeight,A=Math.max(4,Math.min(o-x/2,window.innerWidth-x-4)),R=r+12;R+b>window.innerHeight-4&&(R=Math.max(4,r-b-12)),i.popover.style.left=A+"px",i.popover.style.top=R+"px"}function M(e){n.noteEditing&&!e||(n.noteEditing=null,i.popover.classList.remove("pdfa-open","pdfa-editing","pdfa-exporting","pdfa-menu"),i.popover.innerHTML="")}function mt(e){for(var o=g(),r=[],d=0;d<o.length;d++)r.push(C(o[d],o[d].id===n.activeColorId,function(u){n.activeColorId=u,f(),ke(e,u)},"Highlight"));X(r,e.anchorX,e.anchorY)}function ge(e,o,r,d){for(var u=g(),x=[],b=0;b<u.length;b++)x.push(C(u[b],u[b].id===e.color,function(R){ft(e.id,R)},"Change to"));var A=!!e.note;x.push(E(A?"Edit note":"Add note",d&&!A?"pdfa-btn-primary":"",function(){wt(e,o,r)})),x.push(E("Copy","",function(){At(e)})),x.push(E("Send to note","",function(){It(e)})),x.push(E("Remove","pdfa-remove",function(){gt(e.id)})),X(x,o,r)}function vt(e,o){for(var r=g(),d={},u=0;u<r.length;u++)d[r[u].id]=!0;var x=document.createElement("div");x.className="pdfa-export-hint",x.textContent="Export highlights to a note";var b=document.createElement("div");b.className="pdfa-export-colors";for(var A=0;A<r.length;A++)(function(F){var P=C(F,!0,function(L){d[L]=!d[L],P.setAttribute("aria-pressed",String(d[L]))},"Toggle");b.appendChild(P)})(r[A]);var R=document.createElement("div");R.className="pdfa-note-actions",R.appendChild(E("Create / update note","pdfa-btn-primary",function(){for(var F=[],P=0;P<r.length;P++)d[r[P].id]&&F.push(r[P].id);kt(F.length===r.length?null:F)})),X([x,b,R],e,o,"exporting")}function wt(e,o,r){n.noteEditing=e.id;var d=document.createElement("textarea");d.className="pdfa-note-input",d.rows=3,d.value=e.note||"",d.placeholder="Note for this highlight";var u=document.createElement("div");u.className="pdfa-note-actions",e.note&&u.appendChild(E("Delete note","",function(){fe(e.id,"")}));var x=document.createElement("span");x.className="pdfa-spacer",u.appendChild(x),u.appendChild(E("Cancel","",function(){De(e,o,r)})),u.appendChild(E("Save","pdfa-btn-primary",function(){fe(e.id,d.value)})),d.onkeydown=function(b){b.key==="Enter"&&(b.ctrlKey||b.metaKey)?(b.preventDefault(),b.stopPropagation(),fe(e.id,d.value)):b.key==="Escape"&&(b.preventDefault(),b.stopPropagation(),De(e,o,r))},X([d,u],o,r,"editing"),d.focus(),d.setSelectionRange(d.value.length,d.value.length)}function De(e,o,r){n.noteEditing=null;var d=T(e.id)||e;ge(d,o,r)}function xt(e){if(!n.noteEditing){var o=window.getSelection();if(!(o&&!o.isCollapsed)){for(var r=e.target,d=null;r&&r!==i.pages;){if(r.classList&&r.classList.contains("pdfa-page")){d=r;break}r=r.parentElement}if(!d)return M();var u=Number(d.dataset.page),x=n.viewports[u];if(!x)return M();var b=d.getBoundingClientRect(),A=x.convertToPdfPoint(e.clientX-b.left,e.clientY-b.top),R=s.hitTestHighlights(n.highlights,u,A[0],A[1],1);R&&R.id?ge(R,e.clientX,e.clientY):M()}}}function K(){i.pageLabel.textContent=n.current+" / "+n.pageCount,i.zoomLabel.textContent=Math.round(n.scale*100)+"%"}function me(){return i.root.querySelector(".pdfa-scroll")}function ve(e){var o=Math.min(Math.max(1,e),n.pageCount),r=i.pages.querySelector('[data-page="'+o+'"]');r&&r.scrollIntoView({behavior:"smooth",block:"start"}),n.current=o,K()}function Pe(e){var o=i.pages.querySelector('.pdfa-page[data-page="'+e.page+'"]'),r=n.viewports[e.page];if(!(!o||!r||!e.rects||!e.rects.length)){var d=s.pdfRectToViewportRect(e.rects[0],y(r)),u=me(),x=o.getBoundingClientRect().top+d.y;u.scrollTop+=x-u.getBoundingClientRect().top-u.clientHeight/3,n.current=e.page,K()}}function Ue(e){n.scale=Math.min(Math.max(.4,e),4),m()}function bt(){return n.doc?n.doc.getPage(1).then(function(e){var o=me();if(o){var r=window.getComputedStyle(o),d=o.clientWidth-(parseFloat(r.paddingLeft)||0)-(parseFloat(r.paddingRight)||0),u=e.getViewport({scale:1}).width;if(!(!(d>0)||!(u>0))){var x=Math.max(.4,d/u);x<n.scale&&(n.scale=x,K())}}}).catch(function(){}):Promise.resolve()}function yt(){M();for(var e=i.pages.querySelectorAll(".pdfa-page"),o=n.current,r=1/0,d=0;d<e.length;d++){var u=Math.abs(e[d].getBoundingClientRect().top-60);u<r&&(r=u,o=Number(e[d].dataset.page))}o!==n.current&&(n.current=o,K())}function Ct(){return new Promise(function(e,o){if(window.pdfjsLib)return e(window.pdfjsLib);var r=document.createElement("script");r.src=t.pdfJsSrc,r.onload=function(){window.pdfjsLib?e(window.pdfjsLib):o(new Error("PDF.js loaded but did not register itself."))},r.onerror=function(){o(new Error("Could not load PDF.js from the CDN."))},document.head.appendChild(r)})}function Et(){return new Promise(function(e,o){if(window.PDFLib)return e(window.PDFLib);var r=document.createElement("script");r.src=t.pdfLibSrc,r.onload=function(){window.PDFLib?e(window.PDFLib):o(new Error("pdf-lib loaded but did not register itself."))},r.onerror=function(){o(new Error("Could not load pdf-lib from the CDN."))},document.head.appendChild(r)})}function Nt(){for(var e={},o=g(),r=0;r<o.length;r++)o[r].rgb&&(e[o[r].id]=o[r].rgb);return e}function Tt(){var e=(n.attachmentName||"annotated").replace(/\.pdf$/i,"");return e+"-annotated.pdf"}function He(){for(var e={},o=g(),r=0;r<o.length;r++)o[r].cycleIndex!==void 0&&(e[o[r].id]=o[r].cycleIndex);return e}function Re(){var e=(n.attachmentName||"PDF").replace(/\.pdf$/i,"");return e+" - Highlights"}function Le(e){return l.buildHighlightBlock(n.attachmentName,t.pluginUUID,t.attachmentUUID,e,He()[e.color],t.noteUUID)}function St(e){return navigator.clipboard&&navigator.clipboard.writeText?navigator.clipboard.writeText(e):new Promise(function(o,r){var d=document.createElement("textarea");d.value=e,d.style.position="fixed",d.style.left="-9999px",document.body.appendChild(d),d.focus(),d.select();var u=!1;try{u=document.execCommand("copy")}catch{u=!1}document.body.removeChild(d),u?o():r(new Error("Clipboard access is unavailable here."))})}function At(e){M(!0),St(Le(e)).then(function(){h("Highlight copied - paste it into any note.")}).catch(function(o){h("Could not copy: "+(o.message||o),!0)})}function It(e){M(!0),w({action:"sendToNote",content:Le(e)}).then(function(o){if(!o||o.error)throw new Error(o&&o.error||"Could not send this to the note.");h("Sent to the bottom of this note.")}).catch(function(o){h(o.message||String(o),!0)})}function kt(e){M(!0);var o=l.buildExportAllContent(n.attachmentName,t.pluginUUID,t.attachmentUUID,n.highlights,He(),e,t.noteUUID);if(!o){h(e?"No highlights match those colors.":"No highlights to export yet.",!0);return}w({action:"exportAll",noteName:Re(),content:o}).then(function(r){if(!r||r.error)throw new Error(r&&r.error||"Could not export highlights.");h('Exported to "'+Re()+'".')}).catch(function(r){h(r.message||String(r),!0)})}function Dt(e,o){var r=[E("Collapse","",function(){M(!0),Lt()}),E("Download","",function(){M(!0),Ht()}),E("Export...","",function(){vt(e,o)}),E("Remove viewer...","pdfa-remove",function(){Pt(e,o)})];X(r,e,o,"menu")}function Pt(e,o){var r=document.createElement("div");r.className="pdfa-export-hint",r.textContent="Remove this viewer and all its highlights from this note? This cannot be undone.";var d=document.createElement("div");d.className="pdfa-note-actions",d.appendChild(E("Cancel","",function(){M(!0)}));var u=document.createElement("span");u.className="pdfa-spacer",d.appendChild(u),d.appendChild(E("Remove","pdfa-remove",Ut)),X([r,d],e,o,"exporting")}function Ut(){M(!0),h("Removing this viewer..."),w({action:"removeViewer",attachmentUUID:t.attachmentUUID,pluginUUID:t.pluginUUID}).then(function(e){if(!e||e.error)throw new Error(e&&e.error||"Could not remove this viewer.");document.body.innerHTML='<div style="padding:16px;font:13px sans-serif;opacity:.75">Removed - this block will disappear once the note refreshes.</div>'}).catch(function(e){h(e.message||String(e),!0)})}function Ht(){n.pdfBytes&&(h("Preparing the download..."),Et().then(function(e){return a.writeHighlightsIntoPdf(e,n.pdfBytes,n.highlights,Nt())}).then(function(e){var o=new Blob([e],{type:"application/pdf"}),r=URL.createObjectURL(o),d=document.createElement("a");d.href=r,d.download=Tt(),document.body.appendChild(d),d.click(),d.remove(),setTimeout(function(){URL.revokeObjectURL(r)},4e3),h("")}).catch(function(e){h("Could not prepare the download: "+(e.message||e),!0)}))}function Rt(){return w({action:"loadHighlights",attachmentUUID:t.attachmentUUID}).then(function(e){if(!e||e.error)throw new Error(e&&e.error||"No answer from the plugin");n.highlights=e.highlights||[]}).catch(function(e){n.highlights=[],h("Could not load saved highlights: "+(e.message||e),!0)})}function Lt(){var e=n.highlights.length;i.collapsedCount.textContent=e?e+(e===1?" highlight":" highlights"):"",i.root.classList.add("pdfa-collapsed-mode"),Me(!0)}function Me(e){w({action:"setCollapsed",collapsed:e,attachmentUUID:t.attachmentUUID,pluginUUID:t.pluginUUID}).catch(function(){})}function Mt(){i.root.classList.remove("pdfa-collapsed-mode"),n.doc||Fe(),Me(!1)}function Fe(){h("Loading PDF..."),Ct().then(function(e){return e.GlobalWorkerOptions.workerSrc=t.workerSrc,w({action:"getPdfUrl",attachmentUUID:t.attachmentUUID})}).then(function(e){if(!e||!e.url)throw new Error(e&&e.error||"Could not resolve the PDF URL");return c(e.name),fetch(e.url)}).then(function(e){if(!e.ok)throw new Error("Download failed (HTTP "+e.status+")");return e.arrayBuffer()}).then(function(e){return n.pdfBytes=e.slice(0),window.pdfjsLib.getDocument({data:e}).promise}).then(function(e){return n.doc=e,n.pageCount=e.numPages,Rt()}).then(function(){return bt()}).then(function(){return m()}).then(function(){S();var e=t.highlightId?T(t.highlightId):null;e?Pe(e):t.page&&ve(t.page)}).catch(function(e){h(e.message||String(e),!0)})}try{document.getElementById("pdfa-prev").onclick=function(){ve(n.current-1)},document.getElementById("pdfa-next").onclick=function(){ve(n.current+1)},document.getElementById("pdfa-zoom-in").onclick=function(){Ue(n.scale+.25)},document.getElementById("pdfa-zoom-out").onclick=function(){Ue(n.scale-.25)},i.listToggle.onclick=function(){$()},i.more.onclick=function(e){Dt(e.clientX,e.clientY)},me().addEventListener("scroll",yt),i.pages.addEventListener("mouseup",ne),i.pages.addEventListener("click",xt),document.addEventListener("selectionchange",G),i.pages.addEventListener("touchend",function(){z&&clearTimeout(z),z=null,W()}),document.addEventListener("keydown",function(e){e.key==="Escape"&&!n.noteEditing&&M()}),document.addEventListener("mousedown",function(e){i.popover.classList.contains("pdfa-open")&&(i.popover.contains(e.target)||M())}),p(),k(),i.root.querySelector(".pdfa-collapsed").onclick=Mt,t.collapsed?w({action:"getViewerSummary",attachmentUUID:t.attachmentUUID}).then(function(e){if(!(!e||e.error)){c(e.name);var o=e.count||0;i.collapsedCount.textContent=o?o+(o===1?" highlight":" highlights"):""}}).catch(function(){}):Fe()}catch(e){h("Viewer failed to start: "+(e&&e.message?e.message:e),!0)}}function ht(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Kt(t){return JSON.stringify(t).replace(/</g,"\\u003c")}var en=`
...
`,pt={light:"--pdfa-bg:#f6f7f9; --pdfa-fg:#1c1e21; --pdfa-toolbar:#fff; --pdfa-border:#d8dbe0; --pdfa-btn:#fff; --pdfa-btn-hover:#eceef1; --pdfa-error:#b3261e; --pdfa-accent:#1a6fb5;",dark:"--pdfa-bg:#1e2126; --pdfa-fg:#e6e8ea; --pdfa-toolbar:#252930; --pdfa-border:#3a3f47; --pdfa-btn:#2d323a; --pdfa-btn-hover:#3a4049; --pdfa-error:#f2b8b5; --pdfa-accent:#79b8ef;"};function ut({attachmentUUID:t,attachmentName:s="",page:a=null,highlightId:l=null,lightDarkMode:i="light",pluginUUID:c=null,noteUUID:n=null,collapsed:h=!1}={}){let w=pt[i]||pt.light,g={attachmentUUID:t,page:a,highlightId:l,pluginUUID:c,noteUUID:n,pdfJsSrc:ee.pdfJs,workerSrc:ee.pdfJsWorker,pdfLibSrc:ee.pdfLib,colors:ae.map(I=>({id:I.id,label:I.label,hex:I.hex,rgb:I.rgb,cycleIndex:I.cycleIndex})),defaultColorId:re,collapsed:h,attachmentName:s};return`<link rel="stylesheet" href="${ee.pdfViewerCss}">
<style>:root{${w}}${en}</style>
<div id="pdfa-root"${h?' class="pdfa-collapsed-mode"':""}>
  <div class="pdfa-collapsed">
    ...
    <span class="pdfa-collapsed-name">${ht(s)}</span>
  ...
  <div class="pdfa-filename-bar">
    ...
    <span class="pdfa-brand" title="PDF Annotator plugin">PDF Annotator</span>
    <span class="pdfa-name">${ht(s)}</span>
  </div>
...
<script>window.__PDFA_CONFIG = ${Kt(g)};
window.__PDFA_GEOM = (${Ne.toString()})();
window.__PDFA_ANNOTATIONS = (${Te.toString()})();
window.__PDFA_EXPORT = (${Ae.toString()})();<\/script>
<script>(${ct.toString()})();<\/script>`}var tn={noteOption:{"Annotate PDF":async function(t,s){return Ye(t,s,t.context.pluginUUID)},"Debug: dump note markdown":async function(t,s){return Qe(t,s)}},insertText:async function(t){return Ze(t,t.context.noteUUID,t.context.pluginUUID)},linkTarget:async function(t,...s){return Ke(t,s[0])},renderEmbed:function(t,...s){let{attachmentUUID:a,page:l,highlightId:i,collapsed:c,attachmentName:n}=te(s[0]);return a?ut({attachmentUUID:a,page:l,highlightId:i,collapsed:c,attachmentName:n,lightDarkMode:t.context.lightDarkMode,pluginUUID:t.context.pluginUUID,noteUUID:t.context.noteUUID}):`<p style="font:13px sans-serif;padding:12px">
        This viewer isn't linked to a PDF. Re-run <b>Annotate PDF</b> from the note menu.
      </p>`},onEmbedCall:async function(t,...s){return dt(t,s[0])}},nn=tn;return Bt(on);})();
