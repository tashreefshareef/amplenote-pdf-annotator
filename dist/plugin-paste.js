...
Attach a PDF to this note, then type {PDF Annotator} again where you want the viewer.`),""}let i=await t.getNoteContent({uuid:s});return he(i,a,l.uuid)?(await t.alert(`"${l.name}" already has a viewer in this note.
